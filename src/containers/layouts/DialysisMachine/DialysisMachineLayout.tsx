...
import { dialysisMachineMenuBackExceptions, dialysisMachineMenuItems } from '@containers/layouts/SideBar/constants';
...
export const DialysisMachineLayout = ({ sx }: DialysisMachineLayoutProps) => {
  ...
  return (
    <MainContentContainer fullHeight sx={[{ flexDirection: 'column' }, ...convertSxToArray(sx)]}>
      <BackNavigation backButtonTitle={machine?.name} pathExceptions={dialysisMachineMenuBackExceptions} />
      <Stack
