...
import { CreateQuarterlyBTForm, QuarterlyBtFormType } from '@types';
    ...
    return {
      patient:
        ...
        (quarterlyLabTestPlan
          ...
          : null),
      firstQuarterProcedure: firstQuarterOrder
        ? {
        ...
        : null,
      secondQuarterProcedure: secondQuarterOrder
        ? {
        ...
        : null,
      thirdQuarterProcedure: thirdQuarterOrder
        ? {
        ...
        : null,
      fourthQuarterProcedure: fourthQuarterOrder
        ? {
