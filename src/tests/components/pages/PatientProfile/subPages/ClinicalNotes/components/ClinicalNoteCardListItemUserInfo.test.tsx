...
import {
  ClinicalNoteCardListItemUserInfo,
  ClinicalNoteCardListItemUserInfoProps,
} from '@components/pages/PatientProfile/subPages/ClinicalNotes/ClinicalNoteCard/ClinicalNoteCardListItemUserInfo';
