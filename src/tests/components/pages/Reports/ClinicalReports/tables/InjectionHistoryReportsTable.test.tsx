...
import { InjectionReportFilters, InjectionReportsContentItem } from '@types';
...
import { getGenerateReportDate } from '../../../../../fixtures';
...
describe('InjectionHistoryReportTable', () => {
  ...
  checkTitle(
    ...
    `injectionHistory ${format(getTenantYesterdayDate(), 'dd/MM/yyyy')} ${format(getTenantDate(), 'dd/MM/yyyy')} ${
      ...
      .join('_')}_table.shift ${getGenerateReportDate()}`,
  );
});
