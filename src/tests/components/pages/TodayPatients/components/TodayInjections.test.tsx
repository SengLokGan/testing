import { defaultPlannedInjectionsResponse } from '@src/tests/server/responses';
import { getTestStore, render } from '@src/tests/utils';
import { RenderResult } from '@testing-library/react';
import type { TodayPatientsSliceState } from '@types';
import { AppointmentsStatusesFilters, PatientIsolationFilterNames, TodayPatientsTabs } from '@enums';
import { shifts } from '@src/tests/fixtures';
import TodayInjections from '@src/components/pages/TodayPatients/components/TodayInjections/TodayInjections';
