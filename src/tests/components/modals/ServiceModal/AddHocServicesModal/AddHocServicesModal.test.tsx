...
import { addHocServicesModalFixture } from '../../../../fixtures/addHocServicesModal';
...
describe.skip('AddHocServicesModal', () => {
  ...
  it('should render prefilled labTest form', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByTestId('specimenTypeSelectInput')).toHaveAttribute('value', '');
