...
describe('PatientChangeStatusForm', () => {
  ...
  const TestComponent = ({
    ...
    form = useForm<PatientStatusForm>({ mode: 'onBlur', defaultValues, shouldUnregister: true });
