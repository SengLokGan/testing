...
import { SnackType, DrawerType, ClinicalNoteTypes } from '@enums';
...
describe('clinicalNotesSaga', () => {
    ...
    const clinicalNoteSagaCheck = (
      ...
      it(`${description}`, async () => {
        ...
        expect(dispatched).toEqual([
          ...
          { type: getClinicalNotesList.type, payload: { patientId: payloadMock.patientId } },
        ]);
      });
    };
  ...
  describe('getClinicalNotesListSaga', () => {
    ...
    const clinicalNoteDataMock: ClinicalNotesTableData = {
      content: [
        {
          id: 1,
          patientId: 1,
  ...
  describe('deleteClinicalNoteSaga', () => {
    it('should correctly delete clinical note', async () => {
      ...
      expect(dispatched).toEqual([
        ...
        getClinicalNotesList({ patientId: payloadMock.patientId }),
      ]);
    });
