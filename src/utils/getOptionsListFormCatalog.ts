...
export const DictionariesTranslationsMap = {
  ...
  reuseDialyzerBrand: Dictionaries.ReuseDialyzerBrand,
  singleDialyzerBrand: Dictionaries.SingleDialyzerBrand,
  sterilantType: Dictionaries.SterilantType,
  bayNumber: Dictionaries.BayNumber,
...
export const getOptionListFromCatalog = (name: Dictionaries, disabledOptions?: number[]) => {
  ...
  switch (true) {
    ...
    case name === Dictionaries.AnticoagulantType:
      ...
      break;
    case name === Dictionaries.ReuseDialyzerBrand:
      keysList = Object.keys(REUSE_DIALYZER_BRAND_EN);
      break;
    case name === Dictionaries.SingleDialyzerBrand:
      keysList = Object.keys(SINGLE_DIALYZER_BRAND_EN);
      break;
    case name === Dictionaries.SterilantType:
      keysList = Object.keys(STERLIANT_TYPE_EN);
      break;
    case name === Dictionaries.BayNumber:
      keysList = Object.keys(BAY_NUMBER_EN);
      break;
