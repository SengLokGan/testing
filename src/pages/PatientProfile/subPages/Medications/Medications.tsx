...
import { DrawerType, MedicationDrawerType, PatientStatuses, UserPermissions } from '@enums';
...
export const Medications = () => {
  ...
  const isViewTableShown = userPermissions.includes(UserPermissions.DialysisViewPrescriptions);
  ...
  useEffect(() => {
    if (id) {
      !clinicalInfo && dispatch(getPatientClinicalInfo(id));
    }
  }, [id, clinicalInfo]);
