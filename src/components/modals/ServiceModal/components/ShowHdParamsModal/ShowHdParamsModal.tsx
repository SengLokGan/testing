...
import { countSessionsBetweenDates } from '@utils/countSessionsBetweenDates';
      ...
      <DialogContent sx={{ p: 3 }}>
        {!patientActiveHd ? (
          ...
          <Stack direction="column" spacing={2}>
            ...
            <Stack direction="column" spacing={1}>
              <Typography variant="labelL">{t('addHocEventForm.dialyzer')}</Typography>
              <DataRow
                title={tHdPrescription('tableView.dialyzerUtilization')}
                value={tHdPrescription(`dialyzerUseTypes.${patientActiveHd.dialyzerUseType}`)}
              />
              <DataRow title={tHdPrescription('tableView.dialyzerBrand')} value={patientActiveHd.dialyzerBrand} />
              <DataRow title={tHdPrescription('tableView.surfaceArea')} value={patientActiveHd.surfaceArea} />
            </Stack>
            <Stack direction="column" spacing={1}>
